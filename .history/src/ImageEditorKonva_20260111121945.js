...
const ImageEditorKonva = () => {
  ...
  const handleUpload = (e) => {
    ...
    reader.onload = () => {
      ...
      img.onload = () => {
        ...
        // Calculate initial scale to fit image into canvas
  ...
  <button
    ...
    onClick={() => {
      ...
      loadFrame(require("./assets/frames/frame-white.png"));
    }}
  >
    White
  </button>
  ...
  <button
    ...
    onClick={() => {
      ...
      loadFrame(require("./assets/frames/frame-black.png"));
    }}
  >
    Black
  </button>
  ...
  <button
    ...
    onClick={() => {
      ...
      loadFrame(require("./assets/frames/frame-polaroid.png"));
    }}
  >
    Polaroid
  </button>
